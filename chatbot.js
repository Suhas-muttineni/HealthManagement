    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        form.addEventListener("submit", function (e) {
            ...
            if (userMessage !== "") {
                ...
                // For simplicity, I'm just displaying a placeholder chatbot response.
                displayChatbotMessage("I'm a simple chatbot response.");
        ...
        function displayChatbotMessage(message) {
            ...
            chatbotMessageElement.innerHTML = `<p class="chatbot-text">${message}</p>`;
            conversation.appendChild(chatbotMessageElement);
        }
    });
